...
#ifndef MNIST_MSGS__SRV__MNIST__FUNCTIONS_H_
#define MNIST_MSGS__SRV__MNIST__FUNCTIONS_H_
...
#include "mnist_msgs/msg/rosidl_generator_c__visibility_control.h"

#include "mnist_msgs/srv/mnist__struct.h"

/// Initialize srv/Mnist message.
/**
...
/// Create srv/Mnist message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mnist_msgs__srv__Mnist_Request__init().
...
/// Destroy srv/Mnist message.
/**
 * It calls
 * mnist_msgs__srv__Mnist_Request__fini()
...
/// Initialize array of srv/Mnist messages.
/**
...
/// Finalize array of srv/Mnist messages.
/**
 * It calls
 * mnist_msgs__srv__Mnist_Request__fini()
...
/// Create array of srv/Mnist messages.
/**
 * It allocates the memory for the array and calls
 * mnist_msgs__srv__Mnist_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Mnist messages.
/**
 * It calls
 * mnist_msgs__srv__Mnist_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mnist_msgs__srv__Mnist_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mnist_msgs
...
/**
 * It calls
 * mnist_msgs__srv__Mnist_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mnist_msgs
...
/**
 * It allocates the memory for the array and calls
 * mnist_msgs__srv__Mnist_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mnist_msgs
...
/**
 * It calls
 * mnist_msgs__srv__Mnist_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MNIST_MSGS__SRV__MNIST__FUNCTIONS_H_
