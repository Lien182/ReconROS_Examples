...
proc reconos_hw_setup {new_project_name new_project_path reconos_ip_dir} {
    ...
    set_property -dict [list CONFIG.C_NUM_CLOCKS 1] [get_bd_cells reconos_clock_0]
    ...
    set_property -dict [list CONFIG.C_NUM_HWTS 1 ] [get_bd_cells reconos_memif_arbiter_0]
    ...
    set_property -dict [list CONFIG.C_NUM_INTERRUPTS 1 ] [get_bd_cells reconos_osif_intc_0]
    
    create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_osif:1.0 reconos_osif_0
    set_property -dict [list CONFIG.C_NUM_HWTS  1 ] [get_bd_cells reconos_osif_0]
    
    create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_proc_control:1.0 reconos_proc_control_0
    set_property -dict [list CONFIG.C_NUM_HWTS  1 ] [get_bd_cells reconos_proc_control_0]
    
    create_bd_cell -type ip -vlnv cs.upb.de:reconos:timer:1.0 timer_0

		create_bd_cell -type ip -vlnv cs.upb.de:reconos:rt_mnist:[str range 1.00.a 0 2] "slot_0"
        ...
        create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_sync:1.0 "reconos_fifo_osif_hw2sw_0"
        create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_sync:1.0 "reconos_fifo_osif_sw2hw_0"
        create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_sync:1.0 "reconos_fifo_memif_hwt2mem_0"
        create_bd_cell -type ip -vlnv cs.upb.de:reconos:reconos_fifo_sync:1.0 "reconos_fifo_memif_mem2hwt_0"
	...
	# FIFOs
        ...
        # HWTs
        connect_bd_net [get_bd_pins reconos_clock_0/CLK0_Out] [get_bd_pins "slot_0/HWT_Clk"]
