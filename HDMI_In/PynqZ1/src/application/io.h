...
static uint32_t In32(uint32_t* Addr)
{
	return *(volatile uint32_t *) (Addr);
}

static void Out32(uint32_t* Addr, uint32_t Value)
{
	volatile uint32_t *LocalAddr = (volatile uint32_t *)Addr;
	*LocalAddr = Value;
}

static uint8_t In8(uint32_t* Addr)
{
	return *(volatile uint8_t *) Addr;
}

static void Out8(uint32_t* Addr, uint8_t Value)
{
